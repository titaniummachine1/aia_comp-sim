...
- `bat` O0≠O1 root cause (2026-09-12): new opt-in `tests/pass_bisect.rs` + `PassManager::o1_prefix(k)` run progressive O1 prefixes. `ConstFold`/`RelayRemoval` == O0; **CSE flips bat's aim** from `(0.8833,0.0264)` to `(0.8833,0.8833)` (x==y); `Fusion`/`RegAlloc` inherit it. CSE not disabled. Run: `PASS_BISECT=bat cargo test --test pass_bisect -- --nocapture`. Details: HANDOFF §17b.
