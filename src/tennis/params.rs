...
/// Absolute height the tossed ball reaches = where it is STRUCK (the game's
/// BallY 3.72 arc is the serve FLIGHT apex; the toss itself peaks at the
/// contact height and the strike fires there).
pub const TOSS_APEX_Y: f32 = 3.45;
/// The game strikes the toss at its apex (ball 3.5-3.6 at tick ~86, RISING).
pub const TOSS_STRIKE_Y: f32 = 3.45;
/// Toss launch speed floor. The game rise 1.44 -> apex 3.45 takes 0.4 s
/// (20 ticks = the 1 -> 0.79 charge ramp), i.e. ~10.6 m/s.
pub const TOSS_MIN_SPEED: f32 = 10.5;
